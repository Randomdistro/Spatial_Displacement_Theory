# Volume 10: Molecular Structures Compendium — Book 02: Volume 02: Simple Organic Molecules
...
- Volume 02 Simple Organic Molecules: molecular structure compendium content.
...
### Source: `SDT/Molecular_Structures/Volume_02_Simple_Organic_Molecules.md`

**Artifact type:** molecular compendium  
**Primary focus:** nucleus-driven chemistry and molecular patterning  

This section synthesizes the content implied by `SDT/Molecular_Structures/Volume_02_Simple_Organic_Molecules.md` into the chapter’s narrative. It extracts the
core SDT primitives relevant to **Volume 02 Simple Organic Molecules**, formalizes the key assumptions, and maps the derivation
...
1. Definitions and symbols associated with **Volume 02 Simple Organic Molecules**.
