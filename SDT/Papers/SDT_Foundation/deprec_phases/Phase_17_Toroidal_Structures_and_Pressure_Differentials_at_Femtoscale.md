...
The toroidal structure is the lowest-energy configuration for a stable, rotating displacement vortex. The rotation creates a helical wake (magnetic field), while the toroidal geometry minimizes the surface area-to-volume ratio, reducing the energy required to maintain the displacement against the universal background pressure P_CMB.
...
$$
P(d) = P_CMB \left[1 - \frac{R_t^2 r_t^2}{4d^4}\right] \quad \text{for } d \gg R_t
$$
...
3. The universal background pressure P_CMB
...
The toroidal vortex is stable when the internal pressure from rotation balances the external pressure from P_CMB:

$$
P_{\text{rotation}} = \frac{m_p v_{\text{rotation}}^2}{2\pi R_{\text{torus}} r_{\text{torus}}} \approx P_CMB
$$
