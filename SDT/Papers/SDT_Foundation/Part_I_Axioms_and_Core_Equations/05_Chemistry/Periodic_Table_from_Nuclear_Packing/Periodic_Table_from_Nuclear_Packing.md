...
### 1.4 Nuclei per Nucleus (Developed Structures)

The following packing structures are the *developed* SDT nuclei used throughout the chemistry framework (Phase 1/2 nuclear packing). These entries are the concrete nucleus geometries that drive periodic trends in the present document.
