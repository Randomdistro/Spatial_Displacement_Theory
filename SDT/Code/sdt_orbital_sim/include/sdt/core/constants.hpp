...
namespace sdt::constants {
    ...
    inline constexpr double G_conv = 6.67430e-11;  // Conventional G (m³/kg/s²) for comparison only
    inline constexpr double solar_mass_conv = 1.9885e30;  // Conventional solar mass (kg) for comparison only
